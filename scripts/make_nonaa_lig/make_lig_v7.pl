...
";
 ...
 /\n";
	...
	system("antechamber -fi gout -i $nonaa_name[0]_hf.log -bk $nonaa_name[0] -fo ac -o $nonaa_name[0].ac -c rc -cf resp.chg -at gaff2");
	...
	system("parmchk2 -i $nonaa_name[0].ac -f ac -o $nonaa_name[0]_ff19SB.frcmod -a Y -p \$AMBERHOME/dat/leap/parm/parm19.dat");
